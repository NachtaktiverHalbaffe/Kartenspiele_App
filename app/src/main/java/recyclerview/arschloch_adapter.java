...
public class arschloch_adapter extends ListAdapter<Arschloch_Partie, arschloch_adapter.Arschloch_ListViewHolder> {
    public String mId;
    public static String id;
    View.OnClickListener itemClickListener = null, longClicklistener=null;

    public arschloch_adapter(View.OnClickListener itemClickListener, View.OnClickListener longClicklistener) {
        super(DIFF_CALLBACK);
        this.itemClickListener = itemClickListener;
        this.longClicklistener = longClicklistener;
    }

    private static final DiffUtil.ItemCallback<Arschloch_Partie> DIFF_CALLBACK = new DiffUtil.ItemCallback<Arschloch_Partie>() {
        @Override
        public boolean areItemsTheSame(@NonNull Arschloch_Partie oldItem, @NonNull Arschloch_Partie newItem) {
            return oldItem.getPartiebezeichnung().equals(newItem.getPartiebezeichnung());
        }

        @Override
        public boolean areContentsTheSame(@NonNull Arschloch_Partie oldItem, @NonNull Arschloch_Partie newItem) {
    ...
    class Arschloch_ListViewHolder extends RecyclerView.ViewHolder {
        ...
        public Arschloch_ListViewHolder(View itemView, View.OnClickListener itemClickListener, View.OnClickListener longClicklistener) {                                                     //Variablen fÃ¼r cards setzen
            super(itemView);
    ...
    @Override
    public arschloch_adapter.Arschloch_ListViewHolder onCreateViewHolder(ViewGroup parent, final int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.arschloch_card, null);
        arschloch_adapter.Arschloch_ListViewHolder holder = new arschloch_adapter.Arschloch_ListViewHolder(v, itemClickListener, longClicklistener);
        return holder;
    }

    @Override
    public void onBindViewHolder(final arschloch_adapter.Arschloch_ListViewHolder holder, int position) {
        final Arschloch_Partie arschloch_partie = getItem(position);
        List<Arschloch_Spieler> list = arschloch_partie.getSpieler();
        holder.cv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Id setzen zum eindeutigen identifizieren der Partie
                mId = arschloch_partie.getPartiebezeichnung();
                id = mId;
        ...
        holder.titel.setText(arschloch_partie.getPartiebezeichnung());
        ...
        if(s==7){
            holder.kingt.setText("King");
            holder.vkingt.setText("Vize-King");
            holder.bauer1t.setText("1.Bauer");
            holder.bauer2t.setText("2.Bauer");
            holder.bauer3t.setText("3.Bauer");
            holder.bauer4t.setText("Vize-Arsch");
            holder.varscht.setText("Arsch");
        } else if(s==6){
            holder.kingt.setText("King");
            holder.vkingt.setText("Vize-King");
            holder.bauer1t.setText("1.Bauer");
            holder.bauer2t.setText("2.Bauer");
            holder.bauer3t.setText("Vize-Arsch");
            holder.bauer4t.setText("Arsch");
        } else if(s==5){
            holder.kingt.setText("King");
            holder.vkingt.setText("Vize-King");
            holder.bauer1t.setText("Bauer");
            holder.bauer2t.setText("Vize-Arsch");
            holder.bauer3t.setText("Arsch");
        }else if(s==4){
            holder.kingt.setText("King");
            holder.vkingt.setText("Vize-King");
            holder.bauer1t.setText("Vize-Arsch");
            holder.bauer2t.setText("Arsch");
        } else if(s==3){
            holder.kingt.setText("King");
            holder.vkingt.setText("Bauer");
            holder.bauer1t.setText("Arsch");
        } else if(s==2){
            holder.kingt.setText("King");
            holder.vkingt.setText("Arsch");
        } else holder.kingt.setText("King");

...
public class durak_adapter extends ListAdapter<Durak_Partie, durak_adapter.Durak_ListViewHolder> {
    public String mId;
    public static String id;
    View.OnClickListener itemClickListener = null, longClicklistener= null;

    public durak_adapter(View.OnClickListener itemClickListener, View.OnClickListener longClicklistener) {
        super(DIFF_CALLBACK);
        this.itemClickListener = itemClickListener;
        this.longClicklistener = longClicklistener;
    }

    private static final DiffUtil.ItemCallback<Durak_Partie> DIFF_CALLBACK = new DiffUtil.ItemCallback<Durak_Partie>() {
        @Override
        public boolean areItemsTheSame(@NonNull Durak_Partie oldItem, @NonNull Durak_Partie newItem) {
            return oldItem.getPartiebezeichnung().equals(newItem.getPartiebezeichnung());
        }

        @Override
        public boolean areContentsTheSame(@NonNull Durak_Partie oldItem, @NonNull Durak_Partie newItem) {
    ...
    class Durak_ListViewHolder extends RecyclerView.ViewHolder {
        ...
        public Durak_ListViewHolder(View itemView, View.OnClickListener itemClickListener, View.OnClickListener longclicklistener) {                                                     //Variablen fÃ¼r cards setzen
            super(itemView);
    ...
    @Override
    public durak_adapter.Durak_ListViewHolder onCreateViewHolder(ViewGroup parent, final int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.arschloch_card, null);
        durak_adapter.Durak_ListViewHolder holder = new durak_adapter.Durak_ListViewHolder(v, itemClickListener, longClicklistener);
        return holder;
    }

    @Override
    public void onBindViewHolder(final durak_adapter.Durak_ListViewHolder holder, int position) {
        final Durak_Partie durak_partie = getItem(position);
        List<Durak_Spieler> list = durak_partie.getSpieler();
        holder.cv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Id setzen zum eindeutigen identifizieren der Partie
                mId =durak_partie.getPartiebezeichnung();
                id = mId;
        ...
        holder.titel.setText(durak_partie.getPartiebezeichnung());
        ...
        if(s==7){
            ...
            holder.bauer2t.setText("4.");
            holder.bauer3t.setText("5.");
            holder.bauer4t.setText("Durak");
        } else if(s==5){
            holder.kingt.setText("1.");
            holder.vkingt.setText("2.");
            holder.bauer1t.setText("3.");
            holder.bauer2t.setText("4.");
            holder.bauer3t.setText("Durak");
        }else if(s==4){
            holder.kingt.setText("1.");
            holder.vkingt.setText("2.");
            holder.bauer1t.setText("3.");
            holder.bauer2t.setText("Durak");
        } else if(s==3){
            holder.kingt.setText("1.");
            holder.vkingt.setText("2.");
            holder.bauer1t.setText("Durak");
        } else if(s==2){
            holder.kingt.setText("1.");

        } else if (s==1) holder.kingt.setText("Durak");
